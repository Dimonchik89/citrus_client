...
const HeaderPhoneWindow: React.FC<HeaderPhoneWindowProps> = ({ showPhoneWindow, handleChangeShowPhoneWindow }) => {
	...
	return (
		...
		>
			<HeaderPhoneWindowItem phone="044 502 70 20" text="Оформити замовлення 9:00 - 21:00" />
			<HeaderPhoneWindowItem phone="044 503 70 30" text="Служба підтримки 9:00 - 19:00" />
			...
			<HeaderPhoneWindowForm postPhone={postPhone} showPhoneSended={showPhoneSended} />
		</Box>
	)
}
